...
class DataRouter: ObservableObject {
    ...
    let defaultButtonList = ["EE", "√x", "1/x", "%", "% ∆", "e^x", "ln x", "y^x", "SIN", "COS", "TAN", "ASIN", "ACOS", "ATAN", "π", "D→R", "R→D", "x!", "x√y", "log10", "NPV", "IRR", "CASHF", "MEAN", "SDEV", "NPR", "CDF", "PDF", "NCR", "MAG8", "RAND", "DICE", "SINH", "COSH", "TANH", "e", "log2", "2^x", "10^x"]
